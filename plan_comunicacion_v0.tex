...
\hline
2. Lanzamiento de la Competencia en Acto público  &  05 de Julio del 2018   \rule[-0.2cm]{0cm}{0.6cm}\\
\hline 
3. Publicación de Carteles y Afiches  & Junio, julio y agosto del 2018     \rule[-0.2cm]{0cm}{0.6cm}\\
\hline 
4. Inscripción de  equipos participantes   & 05 de julio 2018 al 14 de enero del 2019  \rule[-0.2cm]{0cm}{0.6cm}\\
\hline
5. Periodo de envió y registro del póster &  05 de julio de 2018 al 14 de enero del 2019  \rule[-0.2cm]{0cm}{0.6cm}\\
\hline
...
\includepdf[pages=1-3]{carta1}
\includepdf[pages=-]{cartel2}
...
\begin{figure}[!htp]
\caption{Algunos posters de la competencia internacional pasada}
\centering
\subfigure[Japon]{\includegraphics[scale=0.22]{japan}}
\subfigure[Rusia]{\includegraphics[scale=0.13]{rusia}}
\subfigure[Mexico]{\includegraphics[scale=0.08]{mexico}}
...
\includepdf[pages=-]{ISLP_Inter1.pdf}
\includepdf[pages=-]{ISLP_Int2.pdf}
